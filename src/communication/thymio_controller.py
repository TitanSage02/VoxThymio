...
class ThymioController:
    ...
    def _load_commands(self) -> Dict[str, str]:
        ...
        try:
            # Chemin vers le fichier commands.json
            commands_path = pathlib.Path(__file__).parent.parent.parent / "commands.json"
            ...
            # Commandes par défaut au cas où
            return { 
